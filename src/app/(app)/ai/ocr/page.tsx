...
import { OcrView } from "@/features/ai/ocr/components/ocr-view";

export const metadata: Metadata = {
  title: "AI OCR",
  description:
    "Extract structured data from bills, invoices, receipts, challans and labels.",
};
...
export default async function AiOcrPage({
  ...
  return <OcrView organizationId={activeOrg.id} canGenerate={canGenerate} />;
}
