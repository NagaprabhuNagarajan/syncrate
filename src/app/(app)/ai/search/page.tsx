...
import { SmartSearchView } from "@/features/ai/search/components";

export const metadata: Metadata = {
  title: "Smart Search",
  description: "Ask in plain language and let AI query your business data",
};
...
export default async function SmartSearchPage({
  ...
  return (
    <SmartSearchView organizationId={activeOrg.id} canGenerate={canGenerate} />
  );
}
