...
import type {
  ...
  SupplierOption,
  WarehouseOption,
} from "@/features/purchase/components/purchase-return-form";
...
/**
 * Fetches the option lists the purchase return form needs (supplier, warehouse
 ...
 */
export async function fetchPurchaseReturnOptions(
  supabase: AppSupabaseClient,
  organizationId: string
): Promise<PurchaseReturnFormOptions> {
