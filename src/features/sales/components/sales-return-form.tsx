...
function FieldError({ message }: { readonly message?: string }) {
  ...
  return (
    <p className="text-error-600 mt-1.5 flex items-center gap-1.5 text-xs" role="alert">
    ...
    >
      <div className="mb-6 flex items-start gap-4">
        <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-50">
          <RotateCcw className="h-5 w-5 text-primary-600" aria-hidden="true" />
        </div>
        <div>
        ...
        <div className="flex justify-end">
          <dl className="w-full max-w-xs space-y-2 rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <dd className="tabular-nums text-slate-700">{formatCurrency(taxTotal)}</dd>
            </div>
