...
export function ProposedActionCard({
  ...
  return (
    <motion.div
      ...
      className="mt-3 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900"
    >
        ...
        <table className="w-full text-left text-sm">
          ...
          <tfoot>
            <tr className="border-t border-slate-100 dark:border-slate-800">
              <td
                className="px-4 py-2 text-right text-xs font-medium uppercase text-slate-500 dark:text-slate-400"
                colSpan={4}
              >
                Subtotal (excl. tax)
              </td>
