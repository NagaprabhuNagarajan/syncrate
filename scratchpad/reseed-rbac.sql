-- =============================================================
-- RE-SEED RBAC reference data (system roles, permissions,
-- role_permissions) wiped by the flush. Idempotent (ON CONFLICT).
-- Run in the Supabase SQL editor. Restores org-creation.
-- =============================================================
...
-- Remove any orphaned organizations created without an owner membership
-- (e.g. the failed 'Prabhu' attempt) so you can re-create cleanly.
